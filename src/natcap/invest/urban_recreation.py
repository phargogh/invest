...
ARGS_SPEC = {
    ...
    "args": {
        ...
        "lulc_raster_path": {
            ...
            "about": (
                "A raster containing integer values representing the LULC code "
                "for each cell. The model will use the resolution of "
                "this layer for all raster outputs.  The resolution should "
                "be small enough to capture the effect of green space in the "
        ...
        "admin_unit_boundary_vector_path": {
            ...
            "required": True,
            "about": (
                "A vector delineating SOMETHING DON'T FORGET TO FILL THIS IN."
            )
        },
        "lulc_attribute_table_path": {
            "name": "LULC Attribute Table",
            "type": "csv",
            "required": True,
            "validation_options": {
                "required_fields": ["lulc_code", "greenspace"],
            },
            "about": (
                "A CSV table mapping landcover codes to greenspace value "
